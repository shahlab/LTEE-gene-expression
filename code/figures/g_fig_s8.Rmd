...
pps.df <- read_csv("../../data_frames/pps_scores.csv")

kegg.df <- read_csv("../../data_frames/kegg_results.csv")
...
ggsave(ff, filename = "../../figures/g_fig_s8.pdf", width = 16, height = 8, device = cairo_pdf)

ggsave(ff, filename = "../../figures/g_fig_s8.png", dpi = 300, width = 16, height = 8)
```

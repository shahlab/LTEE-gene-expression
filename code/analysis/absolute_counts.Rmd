...
ercc.per.sample <- read_csv("../../data_frames/ercc_molecules_per_sample.csv")

# the colony counts per sample
col.counts <- read_csv("../../data_frames/col_counts.csv")
```   
...
Join the CFU data to the above data and add a column that is the number of molecules per cfu, the average CFU from triplicates is used for this. 
```{r}
...
Save it
```{r}
write_csv(kdf3, "../../data_frames/molecules_per_cfu.csv")
```
